...
```{r plot horses, fig.width=10, fig.height=3, fig.cap = 'Figure 1. Number of horses per province in Canada from 1906 to 1972', out.width='100%'}
...
max_horses <- horse_pop %>% 
  ...
  summarize(Maximum = max(Value),
            Minimum = min(Value))
knitr::kable(max_horses, caption = "Table 1. Maximum & Minimum Number of Horses in each Province of Canada Between 1940 - 1972")
```

Below we zoom in and look at the province of `r params$province`:

```{r plot province, fig.width=5, fig.height=4, fig.cap="Figure 2. Number of Horses in Alberta from 1906 to 1972"}
